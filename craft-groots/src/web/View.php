...
use globalia\groots\web\twig\Extension;
use craft\web\twig\GlobalsExtension;
use craft\web\twig\SinglePreloaderExtension;
use globalia\groots\web\twig\TemplateLoader;
use LogicException;
use Throwable;
...
class View extends \yii\web\View
{
    ...
    private function _resolveTemplateInternal(string $name, bool $publicOnly): string|false
    {
        ...
        //If the name starts with / and includes 'groots/workspace/setup' then return the path to the template
        if (str_starts_with($name, '/') && str_contains($name, 'groots/workspace')) {
            return $name;
        }
